...
class acoes_Dividend_yield extends StatefulWidget {


  @override
  State<acoes_Dividend_yield> createState() => _acoes_Dividend_yieldState();
}

class _acoes_Dividend_yieldState extends State<acoes_Dividend_yield> {
  @override
                                ...
                                child: Padding(
                                  ...
                                  child: Column(
                                    children: [
                                      ...
                                      SizedBox(height: 30,),
                                      Text('Dúvidas sobre o que é dividend yield de uma ação?', style: TextStyle(fontWeight: FontWeight.bold, fontSize: 18,color: Colors.black),),
                                      Padding(
              ...
              child: Container(
                ...
                decoration: BoxDecoration(
                  ...
                  image: DecorationImage(
                      image: AssetImage("images/Acoes_Dividend_yield.png"
                      )
                  ),
            ...
            Padding(
              ...
              child: Card(
                ...
                child: Padding(
                  ...
                  child: Text('O dividend yield é uma importante métrica utilizada para avaliar uma ação, pois este cálculo mostra a rentabilidade dos dividendos em relação ao preço da ação. Para realizar esse cálculo, basta dividir o valor de dividendos pagos por ação em 1 ano pelo preço individual da ação antes dessa distribuição de dividendos. Depois, é só multiplicar esse resultado por 100.'
