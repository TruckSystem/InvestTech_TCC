...
class riscos_Renda_fixa extends StatefulWidget {


  @override
  State<riscos_Renda_fixa> createState() => _riscos_Renda_fixaState();
}

class _riscos_Renda_fixaState extends State<riscos_Renda_fixa> {
  @override
                                ...
                                child: Padding(
                                  ...
                                  child: Column(
                                    children: [
                                      ...
                                      SizedBox(height: 30,),
                                      Text('Dúvidas sobre os riscos da renda fixa?', style: TextStyle(fontWeight: FontWeight.bold, fontSize: 18,color: Colors.black),),
                                      Padding(
                    ...
                    child: Container(
                      ...
                      decoration: BoxDecoration(
                        ...
                        image: DecorationImage(
                            image: AssetImage("images/riscos_fixa.jpg"
                            )
                        ),
                      ),
                    ),
                  ...
                  Padding(
                    ...
                    child: Card(
                      ...
                      child: Padding(
                        ...
                        child: Text(
                          'Os riscos dos investimentos em renda fixa em comparação ao investimentos em renda variável são poucos, mas existem ao contrário do que muitos pensam. O grande risco que existe é o próprio risco de crédito, ou seja, existe à possibilidade do emissor do título não conseguir pagar os juros ou o principal no vencimento do título. Por isso, é essencial que os investidores em renda fixa estejam cientes desse risco e avaliem cuidadosamente suas opções de investimento.'
